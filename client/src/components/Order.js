...
const Order = ({ order, setOrder, completed, setCompleted, user }) => {
  ...
  return (
    <>
      <Container maxWidth="xs" style={{ backgroundColor: '#ffff', float: 'left' }}>
        <Box borderBottom={10} borderColor="#000">
          <Typography variant="h5" style={{ color: 'black', textAlign: 'center', marginTop: 20 }}>
            🍳 Simple POS
          </Typography>
        </Box>
        {/* TODO: style */}
        ...
        <Typography variant="h5" component="h2" style={{ color: 'black', textAlign: 'center', marginTop: 20 }}>
          Total: ${totalCost}
        </Typography>
